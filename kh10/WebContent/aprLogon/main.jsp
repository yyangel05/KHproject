...
<table width=500 cellpadding="0" cellspacing="0" align="center" border="1">
	<tr>
		...
		<tr>
			<td></td>
			<td>
				<input type="button" value="아이디찾기" onclick="javascript:window.location='findID.jsp'">
			</td>
			<td>	
				<input type="button" value="패스워드찾기" onclick="javascript:window.location='findPasswd.jsp'"> 
			</td>
		</tr>
	</form>	
</table>
