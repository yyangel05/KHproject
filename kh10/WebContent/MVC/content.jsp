...
<table width="500" border="1" cellspacing="0" cellpadding="0" align="center">
	...
	<tr height="30">
		...
		onclick="document.location.href='/kh10/MVC/updateForm.do?num=${article.num}&pageNum=${pageNum}'">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="글삭제" 
		onclick="document.location.href='/kh10/MVC/deleteForm.do?num=${article.num}&pageNum=${pageNum}'">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="답글쓰기" 
		onclick="document.location.href='/kh10/MVC/writeForm.do?num=${article.num}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}'">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="글목록" 
		onclick="document.location.href='/kh10/MVC/list.do?pageNum=${pageNum}'">
		</td>
	</tr>
</table>
</form>
