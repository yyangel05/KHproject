...
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="/kh10/MVC/updatePro.do?pageNum=${pageNum}" onsubmit="return writeSave()">
...
<!-- 	버튼 폼 -->
	<tr>
		<td colspan="2" bgcolor="${value_c}" align="center">
			...
			<input type="button" value="목록보기" OnClick="window.location='/kh10/MVC/list.do?pageNum=${pageNum}'">
		</td>
	</tr>
</table>
</form>
